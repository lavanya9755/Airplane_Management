...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        //JComboBox or Choice() for dropdown
        
        source = new Choice();
        source.setBounds(220, 330, 150, 25);  
       // source.add("Code in java")     for hard code
        add(source);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()== fetchButton ){
            ...
            String dest = source.getSelectedItem();

            try{
                Conn conn = new Conn();
                String query2 = "select * from flight where source = '"+src+"'";
            ...
            try{
                Conn conn = new Conn();
                String query3 = "insert into reservation values('PNR-"+rm.nextInt(1000000)+"' , 'TIC-"+rm.nextInt(10000)+"','"+aadhar+"','"+name+"','"+nationality+"','"+flightname+"','"+flightcode+"','"+src+"','"+dest+"','"+ddate+"')";
